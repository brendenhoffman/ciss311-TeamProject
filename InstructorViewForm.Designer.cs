namespace ciss311_TeamProject
{
    partial class InstructorViewForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            studentListBox.Location = new Point(131, 106);
            studentListBox.Name = "studentListBox";
            studentListBox.Size = new Size(169, 124);
            ...
            courseListBox.Location = new Point(415, 106);
            courseListBox.Name = "courseListBox";
            courseListBox.Size = new Size(172, 124);
            courseListBox.TabIndex = 2;
            courseListBox.SelectedIndexChanged += listBox2_SelectedIndexChanged;
            // 
            // studentCountLabel
            // 
            studentCountLabel.AutoSize = true;
            studentCountLabel.Location = new Point(30, 267);
            ...
            label1.Location = new Point(309, 106);
            label1.Name = "label1";
            label1.Size = new Size(81, 15);
            label1.TabIndex = 5;
            label1.Text = "CourseListBox";
            ...
            label2.TabIndex = 6;
            label2.Text = "StudentListBox";
            // 
            // label3
            // 
            label3.AutoSize = true;
            label3.Location = new Point(82, 55);
            label3.Name = "label3";
